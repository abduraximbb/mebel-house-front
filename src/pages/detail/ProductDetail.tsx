...
import { FaStar, FaStarHalfAlt, FaRegStar, FaFacebook, FaLinkedin, FaTwitter } from "react-icons/fa";
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="grid grid-cols-5 gap-2">
            {product.images.map((img, index) => (
              <img
                ...
                onClick={() => setSelectedImage(`${import.meta.env.VITE_BASE_IMAGE_URL}${img}`)}
              />
            ))}
          </div>
        ...
        <div>
          ...
          <p className="text-2xl text-gray-500 mt-2">RS. {product.price.toLocaleString()}</p>

          <div className="mt-4 flex items-center space-x-2">
            {renderRating(product.avg_rating)}
            <span className="text-gray-600 text-sm">({product.avg_rating})</span>
          </div>

          <p className="text-gray-700 dark:text-black mt-4">{product.description}</p>
          ...
          <div className="mt-10">
            ...
            {activeTab === "reviews" && (
              <div className="mt-4 text-gray-600">
                <p><strong>Reviews:</strong> No reviews yet. Be the first to review this product!</p>
              </div>
            )}
            ...
            {activeTab === "additionalInfo" && (
              <div className="mt-4 text-gray-600">
                ...
                <p><strong>Price:</strong> {product.price.toLocaleString()} USD</p>
